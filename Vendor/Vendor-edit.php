...
$sql = "SELECT * FROM tb_vendor WHERE id = '$id'";
        ...
        <div class="right_content">
            ...
            <div class="content">
                ...
                <div class="form-login">
                    <form action="vendor-proses.php" method="post" enctype="multipart/form-data">
                        ...
                        <input class="input" type="text" name="telp" id="telp" placeholder="telp" value="<?= $data['Telp'] ?>" />

                        <label for="harga">kota</label>
                        <input class="input" type="text" name="kota" id="kota" placeholder="kota" value="<?= $data['Kota'] ?>" />
