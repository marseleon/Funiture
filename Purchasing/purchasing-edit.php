...
$sql = "SELECT * FROM tb_purchasing WHERE id = '$id'";
...
<body>
    <div class="container">
        ...
        <div class="right_content">
            ...
            <div class="content">
                <h3>Edit Phurchasing</h3>
                <div class="form-login">
                    <form action="purchasing-proses.php" method="post" enctype="multipart/form-data">
                        ...
                        <input class="date" type="date" name="tglorder" id="tglorder" placeholder="tglorder" value="<?= $data['tglorder'] ?>" />
